...
# --- Константы (ВСТАВЛЕННЫЕ ДАННЫЕ - НЕ ТРОГАЙ ИХ!) ---
# ВОТ ЗДЕСЬ ТВОЙ ТОКЕН, БРО! ЭТА СТРОКА САМАЯ ГЛАВНАЯ ДЛЯ ТОКЕНА БОТА.
TELEGRAM_BOT_TOKEN = "8574471908:AAHKHzTOT39e4fz4kgRjeHIR4E2EeeHm-Ak" # <--- ВОТ ТВОЙ НОВЫЙ ТОКЕН
